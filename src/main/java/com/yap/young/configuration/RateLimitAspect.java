...
import com.yap.young.exception.RateLimitException;
...
public class RateLimitAspect {
    ...
    public static final String ERROR_MESSAGE = "To many request at endpoint %s from IP %s! Please try again after 5 minutes!";
    ...
    /**
     * Executed by each call of a method annotated with {@link RateLimitException} which should be an HTTP endpoint.
     ...
     */
    @Before("@annotation(com.yap.young.exception.annotation.WithRateLimitProtection)")
